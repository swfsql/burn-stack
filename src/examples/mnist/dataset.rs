...
/// Collates [`MnistFlatItem`]s into an [`MnistBatch`] on a device.
pub struct MnistBatcher {}

#[derive(Clone, Debug)]
/// One collated batch: raw brightness images plus their integer labels.
...
impl MnistBatch {
    ...
    /// Per-pixel standard deviation of the normalised dataset.
